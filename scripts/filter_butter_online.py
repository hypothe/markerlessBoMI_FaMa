...
class FilterButter3:
    ...
    def __init__(self, pass_type, nc = 2):
        ...
        if self._pass_type == "lowpass_4":
            self._a1 = -2.250085081726394 # -2.498608344691178  # -2.003797477370017; -2.250085081726394; -2.498608344691178
            self._a2 = 1.756401381785953  # 2.115254127003159  # 1.447054019489380; 1.756401381785953; 2.115254127003159
            self._a3 = -0.468312111171712 # -0.604109699507275  # -0.361795928227867; -0.468312111171712; -0.604109699507275
            self._b0 = 0.004750523610981  # 0.001567010350588  # 0.010182576736437; 0.004750523610981; 0.001567010350588
            self._b1 = 0.014251570832943  # 0.004701031051765  # 0.030547730209311; 0.014251570832943; 0.004701031051765
            self._b2 = 0.014251570832943  # 0.004701031051765  # 0.030547730209311; 0.014251570832943; 0.004701031051765
            self._b3 = 0.004750523610981  # 0.001567010350588  # 0.010182576736437; 0.004750523610981; 0.001567010350588
